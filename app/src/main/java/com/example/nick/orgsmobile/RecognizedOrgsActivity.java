...
public class RecognizedOrgsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navMyProfile) {
            Intent myProfileIntent = new Intent(RecognizedOrgsActivity.this, MyProfileActivity.class);
            startActivity(myProfileIntent);
        } else if (id == R.id.navMyOrgs){
            Intent myOrgsIntent = new Intent(RecognizedOrgsActivity.this, MyOrgsActivity.class);
            startActivity(myOrgsIntent);
        } else if (id == R.id.navHome) {
            NavUtils.navigateUpFromSameTask(this);
        } else if (id == R.id.navApplyForRecognition) {
            Intent applyForRecognitionIntent = new Intent(RecognizedOrgsActivity.this, OrgRecognitionActivity.class);
            startActivity(applyForRecognitionIntent);
        } else if (id == R.id.navRecognitionGuidelines) {
            Toast.makeText(RecognizedOrgsActivity.this, "" + item.getTitle(), Toast.LENGTH_SHORT).show();
            return true;
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
